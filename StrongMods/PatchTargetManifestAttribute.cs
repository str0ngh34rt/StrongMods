...
namespace StrongMods {
  ...
  ///   <b>
  ///     This attribute is inert: nothing in the game or Harmony invokes a tagged method, and
  ///     tagging patches nothing.
  ///   </b>
  ///   Unlike Harmony's <c>[HarmonyTargetMethod]</c>/<c>TargetMethod()</c>
  ...
  ///   The repo currently has no programmatic patch site (#44 converted the last one to categorized
  ///   attribute patches); the conformance test in <c>Tests</c> enforces this pattern if one returns.
  /// </summary>

...
| :--- | :--- |
| **AECInternationalMarketFixes** | Fixes for the AEC International Market mod. |
...
| **DisableLAN** | Prevents the LAN announcer from binding to port 11000 to save resources. |
...
| **StrongBoxes** | Change box behavior based on the labels. |
